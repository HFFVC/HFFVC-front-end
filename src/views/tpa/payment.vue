    ...
    <div class="row content">
      ...
      <div class="col-md-10 content-container">
        ...
        <div class="main-container">
          <div id="people" class="invoice-payment-table-wrap">
            <v-client-table
      ...
      >
        ...
        <div class="button-container" v-if="invoiceReadonly == false">
          <input
            type="button"
      ...
      >
        <perfect-scrollbar class="modal-scroll">
          ...
          <div class="inp-container">
            <label class="input-label">Net Receivables</label>
            <input
              class="text-input"
              type="number"
              :readonly="isPaymentConfirmed"
          ...
          <div class="inp-container" v-if="wasFactored == 'Yes'">
            <label class="input-label">Factoring Entity</label>
            <input
              class="text-input"
              :readonly="isPaymentConfirmed"
              type="text"
          ...
          <div class="inp-container" v-if="wasFactored == 'Yes'">
            <label class="input-label">Factoring Agent</label>
            <input
              class="text-input"
              :readonly="isPaymentConfirmed"
              type="text"
          ...
          <div class="inp-container" v-if="wasFactored == 'Yes'">
            <label class="input-label">Factoring Charges (%)</label>
            <input
              class="text-input"
              :readonly="isPaymentConfirmed"
              type="number"
        ...
        <div class="button-container" v-if="isPaymentConfirmed == false">
          <input
            type="button"
      ...
      >
        <h4 class="confirm-message">
          Net Sales is:
          <label>{{ netSales }}USD</label> and Net receivables is:
          <label>{{ netReceivables }}USD</label>. Are you sure you want to
          confirm the payment??
        </h4>
...
export default {
  ...
  methods: {
    ...
    getData: function() {
      ...
      ref.on("child_added", function(snapshot) {
        ...
        if (snapshot.val().invoice != undefined) {
          let buyerFeedbackStatus = "Not Responded";
          if (snapshot.val().buyerFeedback) {
            if (snapshot.val().buyerFeedback.invoiceAcceptance == "Y") {
              buyerFeedbackStatus = "Accepted";
            } else if (snapshot.val().buyerFeedback.invoiceAcceptance == "N") {
              buyerFeedbackStatus = "Rejected";
            }
          }
          isPaymentShow = true;
          currentValue.serviceRequests.push({
            ...
            "Feedback Status": buyerFeedbackStatus,
    ...
    showHome: function() {
      Router.push({ path: "/view-tpa-batches" });
    },
    ...
    confirmPayment: function(item) {
      ...
      currentVal.invoiceURL =
        `${getConfigVars().APP_URL}broker-invoice/` + currentVal.selectedRow.sellId;
      var ref = firebase
        .database()
        .ref()
        .child("batch")
    ...
    SaveGI: function() {
      ...
      var inpData = {
        ...
        billingDate: moment(currentVal.billingDate)
          .utc()
          .toString(),
      ...
      dbRef
        ...
        .then(function() {
          ...
          // currentVal.axios
          //   .post(
          //     "${getConfigVars().BASE_URL}/api/v1/corda/chain/sale/process",
          //     {
          //       lotId: currentVal.lotId,
          //       saleId: currentVal.selectedRow.sellId,
          //       data: {
          //         penalties: [
          //           {
          //             type: "BR_NO_SALE"
          ...
          //           }
          //         ],
          //         receiptHash: currentVal.invoiceNo,
          //         boxesAmount: currentVal.selectedRow["No of Boxes"],
          //         pricePerKg: currentVal.selectedRow.salesPricePerKg,
          //         retailer: currentVal.selectedRow.sellBuyerOrganization
          //       }
          //     }
          //   )
          //   .then(function() {
    ...
    SaveConfirmPayment: function() {
      ...
      var inpData = {
        ...
        paymentNetReceivablesCurrency: currentVal.paymentNetReceivablesCurrency,
        netReceivables: currentVal.netReceivables,
        wasFactored: currentVal.wasFactored,
        amountFactored: currentVal.amountFactored,
        factoringEntity: currentVal.factoringEntity,
        factoringAgent: currentVal.factoringAgent,
        factoringContactDetails: currentVal.factoringContactDetails,
        factoringCharges: currentVal.factoringCharges
      };

      console.log("$$$$$$$$$$$$$");
      console.log(currentVal.lotId);
        ...
        .on("child_added", function(snapshot) {
          ...
          dbRef
            ...
            .then(function() {
              ...
              //         //     delivery_time: null,
              //         //     fruits_amount: null,
              //         //     boxes_amount: lossOfBox,
              //         //     temperature_breach_count: temperatureBreachCount
              //         //   }
              //         // ],
              //         receiptHash: currentVal.confirmPaymentInvoiceNo,
              //         boxesAmount: currentVal.selectedRow["No of Boxes"],
              //         pricePerKg: currentVal.selectedRow.salesPricePerKg,
              //         retailer: currentVal.selectedRow.sellBuyerOrganization
              //         //internalFruitTemp,
