    ...
    <div class="row content">
      ...
      <div class="col-md-5 details-container add-collector-wrap">
        <div class="header-container">
          <h6 class="heading">
            {{ $t("Enrolled Collectors", "Enrolled Collectors") }}
          </h6>
        </div>
        ...
        <div class="button-container">
          <input
            ...
            :value="$t('Create New Collector', 'Create New Collector')"
            ...
            <div class="card-body add-collector-field-wrap">
              <div class="emptyContainer" v-if="isEmptyContainer">
                <h4 class="card-inside-description">
                  {{
                    $t(
                      "Select a Collector to Edit & Update OR Create a New Collector",
                      "Select a Collector to Edit & Update OR Create a New Collector"
                    )
                  }}
                  <!-- Select a Collector to Edit &amp; Update
                  <br />OR
                  <br />Create a New Collector -->
                </h4>
              </div>
                  ...
                  <div class="col-md-12">
                    <div class="inp-container">
                      <input
                        ...
                        :readonly="
                          pageTitle ==
                          $t('Edit Collector Details', 'Edit Collector Details')
                        "
                      />
                    </div>
                  </div>
...
export default {
  ...
  data: function () {
    return {
      seen: true,
      userName: null,
      pageTitle: this.$t("Collector Details", "Collector Details"),
      collectorsList: [],
  ...
  mounted() {
    if (localStorage.systemRole == 99) {
      ...
      this.$refs.headercomp.createBreadcrumb([
        ...
        {
          text: this.$t("Add Collector", "Add Collector"),
          href: "/add-collector",
        },
      ]);
      }
  ...
  methods: {
    ...
    getCollectorsList: function () {
      ...
      ref.on("value", function (snapshot) {
        ...
        snapshot.forEach((requestData) => {
          ...
          // let organizationKey = requestData.val().organizationKey || "";
          let _data = {
            email,
            firstName,
            lastName,
          ...
          if (organizationKey == localStorage.organizationKey) {
    ...
    saveCollectorDetails: function () {
      ...
      if (
        this.pageTitle ==
        this.$t("New Collector Details", "New Collector Details")
      ) {
        const {
          firstName,
          lastName,
        ...
        if (firstName && lastName && email && contact && organizationSelected) {
            ...
            firebase
              ...
              .then(function (response) {
                ...
                const dataToPush = {
                  ...
                  contact,
                  collectorAddedBy: localStorage.userName,
                ...
                sendMail(
                  email,
                  `${dataToPush.firstName} ${dataToPush.lastName}`,
                  userPassword
                )
                  .then((emailSent) => {
                    ...
                    const ref = firebase
                      ...
                      .then((inserted) => {
                        ...
                        vm.addMapping(snapshot, dataToPush.organization);
                        Vue.$toast.open({
                          message: vm.$t(
                            "New collector has been added.",
                            "New collector has been added."
                          ),
                          type: "success",
                          position: "top",
              ...
              .catch((error) => {
                ...
                Vue.$toast.open({
                  message: vm.$t(
                    "Error creating a new collector, email id already regsitered.",
                    "Error creating a new collector, email id already regsitered."
                  ),
                  type: "error",
                  position: "top",
        ...
        this.pageTitle ==
        this.$t("Edit Collector Details", "Edit Collector Details")
      ) {
        const { firstName, lastName, email, contact, roleDesc } = this;
        // const organization = vm.mappedOrganization[vm.organizationSelected];
        const _systemRole = 3;
        const func = "Collector";
        const dataToUpdate = {
          firstName,
        ...
        const ref = firebase
          ...
          .then(
            () => {
              vm.addMapping(vm.snapshotKey, dataToUpdate.organization);
              Vue.$toast.open({
                message: vm.$t(
              ...
              vm.selectedCollector = null;
              vm.clearAll();
              this.pageTitle = vm.$t("Collector Details", "Collector Details");
              this.getCollectorsList();
              this.seen = false;
              vm.snapshotKey = null;
            },
