    ...
    <div class="row-content">
      <div class="col-md-8 content-container">
        ...
        <div class="main-container">
          <div class="tbl-services">
            ...
            >
              ...
              <tr>
                ...
                <td>{{ sellingAddressLine1 }}</td>
              </tr>
              <tr>
                <td>Address Line 2</td>
                <td>{{ sellingAddressLine2 }}</td>
              </tr>
              <tr>
                <td>Address Line 3</td>
                <td>{{ sellingAddressLine3 }}</td>
              </tr>
              <tr>
          ...
          <!-- <button id="ignoreThis" @click="showPDF">Download Invoice</button> -->
        </div>
      </div>
      <p id="ignorePDF"></p>
...
export default {
  ...
  methods: {
    showPDF() {
      ...
      // uncomment for viewing pdf file.
      // doc.output("dataurlnewwindow");
      doc.save(`${this.invoiceNumber}.pdf`);
    },
    getInvoiceDetails(invoiceNumber) {
      ...
      firebase
        ...
        .ref()
        .child("batch")
        .orderByChild("proforma/batchProforma_ProformaNo")
        .equalTo(invoiceNumber)
        .on("child_added", function(snapshot) {
          if (
            snapshot.val().proforma &&
            snapshot.val().proforma.batchProforma_ProformaNo == invoiceNumber
          ) {
            const {
              batchProforma_Email,
              batchProforma_FullName,
              batchProforma_ProformaNo,
            ...
            vm.proformaNo = batchProforma_ProformaNo;
            vm.fullName = batchProforma_FullName;
            vm.email = batchProforma_Email;
            vm.sellingAddressLine1 = batchProforma_Selling_AddressLine1;
            vm.sellingAddressLine2 = batchProforma_Selling_AddressLine2;
            vm.sellingAddressLine3 = batchProforma_Selling_AddressLine3;
            vm.shippingAddressLine1 = batchProforma_Shipping_AddressLine1;
            vm.shippingAddressLine2 = batchProforma_Shipping_AddressLine2;
            vm.shippingAddressLine3 = batchProforma_Shipping_AddressLine3;
            vm.unitPrice = batchProforma_Shipping_UnitPrice;
            vm.proformaInvoiceCurrency = batchProforma_Shipping_Currency;
            vm.product = product;
