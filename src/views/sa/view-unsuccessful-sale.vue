    ...
    <div class="row content">
      ...
      <div class="col-md-10 content-container">
        <div class="header-container">
          <h3 class="heading">
            {{ $t("Unsuccessful Sales", "Unsuccessful Sales") }}
          </h3>
          ...
          <div class="col-md-4">
            ...
            <div class="main-container maintain-batch-container">
              ...
              <input
                ...
                :value="$t('Cost of Maturation', 'Cost of Maturation')"
                readonly
              />
            </div>
          </div>
              ...
              <perfect-scrollbar class="maintain-modal-scroll">
                ...
                >
                  <input
                    ...
                    type="text"
                    :placeholder="
                      $t('Cost of Maturation', 'Cost of Maturation')
                    "
                  />
                </div>
              </perfect-scrollbar>
...
export default {
  ...
  data: function() {
    return {
      serviceRequests: [],
      columns: ["Batch Id", "batchCreatedOn", "No Of Lots", "View", "Maintain"],
  ...
  mounted() {
    if (
      ...
      this.$refs.headercomp.createBreadcrumb([
        ...
        {
          text: this.$t("Unsuccessful Sales", "Unsuccessful Sales"),
          href: "/view-unsuccessful-sale",
        },
      ]);
      }
      else
